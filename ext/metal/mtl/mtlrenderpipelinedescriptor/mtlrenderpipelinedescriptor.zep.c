...
PHP_METHOD(Metal_MTL_MTLRenderPipelineDescriptor_MTLRenderPipelineDescriptor, depthAttachmentPixelFormat)
{
	...
	zephir_fetch_params_without_memory_grow(1, 0, &handle_param);
	ZVAL_LONG(&_0, handle);
	RETURN_LONG(mtl_mtlrenderpipelinedescriptor_depth_attachment_pixel_format(&_0));
}

PHP_METHOD(Metal_MTL_MTLRenderPipelineDescriptor_MTLRenderPipelineDescriptor, setDepthAttachmentPixelFormat)
{
	zval *handle_param = NULL, *depthAttachmentPixelFormat_param = NULL, _0, _1;
	zend_long handle, depthAttachmentPixelFormat;

	ZVAL_UNDEF(&_0);
	ZVAL_UNDEF(&_1);
	ZEND_PARSE_PARAMETERS_START(2, 2)
		Z_PARAM_LONG(handle)
		Z_PARAM_LONG(depthAttachmentPixelFormat)
	ZEND_PARSE_PARAMETERS_END();
	zephir_fetch_params_without_memory_grow(2, 0, &handle_param, &depthAttachmentPixelFormat_param);
	ZVAL_LONG(&_0, handle);
	ZVAL_LONG(&_1, depthAttachmentPixelFormat);
	mtl_mtlrenderpipelinedescriptor_set_depth_attachment_pixel_format(&_0, &_1);
}
...
PHP_METHOD(Metal_MTL_MTLRenderPipelineDescriptor_MTLRenderPipelineDescriptor, stencilAttachmentPixelFormat)
{
	...
	zephir_fetch_params_without_memory_grow(1, 0, &handle_param);
	ZVAL_LONG(&_0, handle);
	RETURN_LONG(mtl_mtlrenderpipelinedescriptor_stencil_attachment_pixel_format(&_0));
}

PHP_METHOD(Metal_MTL_MTLRenderPipelineDescriptor_MTLRenderPipelineDescriptor, setStencilAttachmentPixelFormat)
{
	zval *handle_param = NULL, *stencilAttachmentPixelFormat_param = NULL, _0, _1;
	zend_long handle, stencilAttachmentPixelFormat;

	ZVAL_UNDEF(&_0);
	ZVAL_UNDEF(&_1);
	ZEND_PARSE_PARAMETERS_START(2, 2)
		Z_PARAM_LONG(handle)
		Z_PARAM_LONG(stencilAttachmentPixelFormat)
	ZEND_PARSE_PARAMETERS_END();
	zephir_fetch_params_without_memory_grow(2, 0, &handle_param, &stencilAttachmentPixelFormat_param);
	ZVAL_LONG(&_0, handle);
	ZVAL_LONG(&_1, stencilAttachmentPixelFormat);
	mtl_mtlrenderpipelinedescriptor_set_stencil_attachment_pixel_format(&_0, &_1);
}
