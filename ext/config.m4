...
if test "$PHP_METAL" = "yes"; then
	...
	metal/mtl/mtlrenderpassdepthattachmentdescriptor/mtlrenderpassdepthattachmentdescriptor.zep.c
	metal/mtl/mtlrenderpassdescriptor/mtlrenderpassdescriptor.zep.c
	metal/mtl/mtlrenderpassstencilattachmentdescriptor/mtlrenderpassstencilattachmentdescriptor.zep.c
